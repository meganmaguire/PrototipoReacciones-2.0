...
public class ExperimentoController {
    ...
    @FXML
    public void recieveData(Experimento experimento){
        this.experimento = experimento;
        this.pasosExperimento.addAll(this.experimento.getPasos());
        this.edition = true;
    }
    ...
    public void guardarCambios(ActionEvent event){
        if(!this.pasosExperimento.isEmpty()){
            if(edition) {
                ...
                this.contexto.getExperimentos().add(this.experimento);
            }
