...
public class ButtonCellReaccion extends TableCell<Reaccion, Boolean> {
    final Button cellButton = new Button();

    public ButtonCellReaccion(final TableView<Reaccion> tableView, ObservableList<Reaccion> values) {
        styleButton();
        cellButton.setOnAction(new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent t) {
                ...
                Reaccion toRemove = tableView.getItems().get(selectedIndex);
